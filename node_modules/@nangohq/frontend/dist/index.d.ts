...
export default class Nango {
     ...
     */
    auth(providerConfigKey: string, connectionId: string, options?: (ConnectionConfig | OAuth2ClientCredentials | OAuthCredentialsOverride | BasicApiCredentials | ApiKeyCredentials | AppStoreCredentials) & AuthOptions): Promise<AuthResult>;
    /**
...
declare class AuthorizationModal {
     ...
     */
    handleMessage(message: MessageEvent, successHandler: (providerConfigKey: string, connectionId: string) => any, errorHandler: (errorType: string, errorDesc: string) => any): void;
    /**
