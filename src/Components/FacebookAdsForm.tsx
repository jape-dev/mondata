  ...
  return (
    <div className="mt-2">
      ...
      <BoardBlock
        ...
        columnModalTitle="The column containing the Facebook Ad Id, Adset Id or Campaign Id to split metrics by."
        columnModalDescription="For importing into an existing group, each row will need a column containing an id for the ad, adset or campaign. If your board does not have this, please select the 'Import into a new group' option."
