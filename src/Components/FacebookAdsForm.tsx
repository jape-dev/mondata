  ...
  return (
    <div className="mt-2">
      ...
      <BoardBlock
        ...
        columnModalDescription="(Example above). Each row containing an id will have imported metrics for it. If you want to use post urls instead, select the Facebook Posts connector."
